...
def process_json(driver, file_path, df_nodes):
    ...
    for item in tqdm(data):
        ...
        item["medical_concepts_primekg"] = list(medical_concepts)
        new_data.append(item)
...
def process_dataset(driver, dataset, df_nodes):
    directory_path = f'../Pre_Processed_Datasets/{dataset}/1_extracted_entities/'
    for json_file_path in glob.glob(directory_path + '*.json'):
        ...
        new_directory = f"../Pre_Processed_Datasets/{dataset}/2_extracted_concepts"
