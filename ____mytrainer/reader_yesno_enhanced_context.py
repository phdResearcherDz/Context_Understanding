...
def main_enhanced_context():
    ...
    for dataset in datasets:
        train_data = load_dataset_yes_no(dataPath + f"{dataset}/5_formated_metadata/train.json")
        val_data = load_dataset_yes_no(dataPath + f"{dataset}/5_formated_metadata/test.json")
        test_data = load_dataset_yes_no(dataPath + f"{dataset}/5_formated_metadata/test.json")
