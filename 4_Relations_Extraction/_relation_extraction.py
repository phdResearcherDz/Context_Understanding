...
datasets = ["PubmedQA"] #BioASQ,"QA4MRE-Alz","MEDQA" , "MedMCQA"
...
def ProcessPrimeKG():
    ...
    for dataset in datasets:
        process_dataset(driver, dataset,dataset,kg="hetionet",node_name_attribute="node_name",allowed_attributes=allowed_attributes)
...
if __name__ == "__main__":
    ...
    for dataset in datasets:
        ...
        output_file_path = os.path.join(directory_path, f"test_{dataset}_merged_relations.json")
