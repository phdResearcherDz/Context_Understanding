...
def ProcessPrimeKG():
    ...
    for dataset in datasets:
        process_dataset(driver, dataset, kg_name="primekg", node_name_attribute="node_name",
...
def ProcessHetionet():
    ...
    driver = connect_to_neo4j(uri, username, password)
    for dataset in datasets:
        process_dataset(driver, dataset, kg_name="hetionet", node_name_attribute="name",
                        allowed_attributes=allowed_attributes)
...
def relation_extraction():
    ...
    # for dataset in datasets:
    #     directory_path = f"../Pre_Processed_Datasets/{dataset}/4_extracted_concepts_relations_filtered"
    #
